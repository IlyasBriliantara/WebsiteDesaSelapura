          ...
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item mx-1 dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <li>
                  <a class="dropdown-item" href="stk_perangkat_desa.php"
                    >Struktur Perangkat Desa</a
                  >
                </li>
                <li>
      ...
      <div class="row">
        <div class="col-md-12" data-aos="fade-up">
          <div class="section-header text-center pb-5">
            ...
            <p>
              Team Developer pengembang Website Profil Desa Selapura.
            </p>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-12 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="100">
          <div class="card text-center">
            <div class="card-body">
              ...
              <h3 class="card-title py-2">Mohamad Idham Bahri</h3>
              <p class="card-text">Team Developer</p><br><br>

              <p class="socials">
                <a href="#"><i class="bi bi-facebook text-dark mx-1"></i></a>
                <a href="https://www.linkedin.com/in/mohamad-idham-bahri-679201222?originalSubdomain=id"><i class="bi bi-linkedin text-dark mx-1"></i></a>
                <a href="#"><i class="bi bi-instagram text-dark mx-1"></i></a>
                <a href="https://github.com/Idhamm15/"><i class="bi bi-github text-dark mx-1"></i></a>
              </p>
            </div>
          </div>
        </div>
        <div class="col-12 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="200">
          <div class="card text-center">
            <div class="card-body">
              <img src="../images/blank-profile.jpg" alt="" class="img-fluid rounded-circle" />
              <h3 class="card-title py-2">Ainul Kharis</h3>
              <p class="card-text">Team Developer</p><br><br>
              <p class="socials">
                <a href="#"><i class="bi bi-facebook text-dark mx-1"></i></a>
                <a href="https://www.linkedin.com/in/ainul-kharis/?originalSubdomain=id"><i class="bi bi-linkedin text-dark mx-1"></i></a>
                <a href="#"><i class="bi bi-instagram text-dark mx-1"></i></a>
                <a href="https://github.com/ainulkharis"><i class="bi bi-github text-dark mx-1"></i></a>
              </p>
            </div>
          </div>
        </div>
        <div class="col-12 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="300">
          <div class="card text-center">
            <div class="card-body">
              <img src="../images/blank-profile.jpg" alt="" class="img-fluid rounded-circle" />
              <h3 class="card-title py-2">Ilyas Wahyu Putra Briliantara</h3>
              <p class="card-text">Team Developer</p><br><br>
              <p class="socials">
                <a href="#"><i class="bi bi-facebook text-dark mx-1"></i></a>
                <a href="https://www.linkedin.com/in/ilyas-wahyu-putra-briliantara-421412249/?originalSubdomain=id"><i class="bi bi-linkedin text-dark mx-1"></i></a>
                <a href="https://instagram.com/xlyas.png"><i class="bi bi-instagram text-dark mx-1"></i></a>
        ...
        <div class="col-12 col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="400">
          <div class="card text-center">
            <div class="card-body">
              <img src="../images/blank-profile.jpg" alt="" class="img-fluid rounded-circle" />
              <h3 class="card-title py-2">Mohamad Khadik</h3>
              <p class="card-text">Team Developer</p><br><br>
              <p class="socials">
                <a href="#"><i class="bi bi-facebook text-dark mx-1"></i></a>
                <a href="https://www.linkedin.com/in/mohamad-khadik-502831223/?originalSubdomain=id"><i class="bi bi-linkedin text-dark mx-1"></i></a>
                <a href="#"><i class="bi bi-instagram text-dark mx-1"></i></a>
                <a href="https://github.com/khadik86"><i class="bi bi-github text-dark mx-1"></i></a>
              </p>
            </div>
          </div>
        </div>
