    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-12 col-12">
          <div class="about-img">
            <img src="../images/umkm.jpg" alt="" class="img-fluid">
          </div>
        </div>
        <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
          <div class="about-text">
            <h2>UMKM <br /> Desa Selapura</h2>
            <p>Usaha kecil mikro menengah (UMKM), merupakan salahsatu program unggulan dari desa selapura.</p>
            <a href="./unggulan/ukm.php" class="btn btn-warning">Learn More</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
          <div class="about-text">
            ...
            <a href="./unggulan/posyandu.php" class="btn btn-warning">Learn More</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="about" class="about section-padding">
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-12 col-12">
          <div class="about-img">
            <img src="../images/program-ibu-hamil.jpeg" alt="" class="img-fluid">
          </div>
        </div>
        <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
          <div class="about-text">
            <h2>Posbindu</h2>
            <p>Posbindu merupakan pos pembinaan terpadu penyakit tidak
              ...
              yaitu Gula Darah.</p>
            <a href="./unggulan/posbindu.php" class="btn btn-warning">Learn More</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="about" class="about section-padding">
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-12 col-12">
          <div class="about-img">
            <img src="../images/bian.jpeg" alt="" class="img-fluid">
          </div>
        </div>
        <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
          <div class="about-text">
            <h2>BIAN <br /> (Bulan Imunisasi Anak Nasional)</h2>
            <p>BIAN adalah pemberian imunisasi tambahan Campak-Rubela serta
              ...
              DPT-HB-Hib)</p>
            <a href="./unggulan/bian.php" class="btn btn-warning">Learn More</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="about" class="about section-padding">
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-12 col-12">
          <div class="about-img">
            <img src="../images/posyandu-remaja.jpeg" alt="" class="img-fluid">
          </div>
        </div>
        <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
          <div class="about-text">
            <h2>Posyandu Remaja<br /> Services Ever</h2>
            ...
            <a href="./unggulan/posyanduremaja.php" class="btn btn-warning">Learn More</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section id="about" class="about section-padding">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
          <div class="about-text">
            <h2>Kegiatan Ibu Hamil <br /> Services Ever</h2>
            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Totam, labore reiciendis. Assumenda eos quod animi! Soluta nesciunt inventore dolores excepturi provident, culpa beatae tempora, explicabo corporis quibusdam corrupti. Autem, quaerat. Assumenda quo aliquam vel, nostrum explicabo ipsum dolor, ipsa perferendis porro doloribus obcaecati placeat natus iste odio est non earum?</p>
            <a href="./unggulan/ibuhamil.php" class="btn btn-warning">Learn More</a>
          </div>
        </div>
      </div>
    </div>
