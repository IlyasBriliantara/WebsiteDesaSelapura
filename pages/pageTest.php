      ...
      <div class="row">
        <div class="col-lg-4 col-md-12 col-12" data-aos="fade-up">
          <div class="about-img">
            ...
            <h3><span class="text-muted">Bapak. Iman Santoso</span></h3>
            <h2 style="border: solid">Kepala Desa Selapura</h2>
          </div>
        </div>
        ...
        <div class="col-12 col-md-12 col-lg-4" data-aos="fade-up" data-aos-delay="100">
          <div class="card text-light text-center bg-white pb-2">
            <div class="card-body text-dark">
              ...
              <button class="btn bg-warning text-dark">Baca Selengkapnya</button>
            </div>
          </div>
        </div>
