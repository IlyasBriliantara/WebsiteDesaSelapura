...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    <div class="container">
      <a style="font-size: x-large" class="navbar-brand" href="#">
        <img src="../images/logo-seda-selapura.png" alt="" width="30" class="d-inline-block align-text-top me-3" />
  ...
  <img style="width: 100%; height: 400px;" src="../admin1/assets/img/<?= htmlspecialchars($berita['gambar']); ?>" alt="" srcset="">
  <p class="lh-sm"><?= $berita['isiberita']; ?></p>
 </div>
      ...
      <div class="col mb-3">
        <a href="" class="d-flex align-items-center mb-3 link-dark text-decoration-none">
          <svg class="bi me-2" width="40" height="32">
            <use xlink:href="../images/logo-seda-selapura.png" />
          </svg>
          <img class="bi me-2" width="100" height="100" src="../images/logo-seda-selapura.png" alt="" />
        </a>
